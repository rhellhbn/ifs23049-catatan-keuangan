                        ...
                        <div class="mb-4">
                            ...
                            <div class="flex gap-4">
                                <label class="flex items-center">
                                    <input type="radio" name="type" value="income" {{ old('type') == 'income' ? 'checked' : '' }} class="mr-2" required>
                                    <span class="px-4 py-2 bg-green-100 text-green-800 rounded">💰 Pemasukan</span>
                                </label>
                                <label class="flex items-center">
                                    <input type="radio" name="type" value="expense" {{ old('type') == 'expense' ? 'checked' : '' }} class="mr-2" required>
